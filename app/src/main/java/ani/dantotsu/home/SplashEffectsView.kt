...
class SplashEffectsView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        glowPaint.alpha = 115
        // Android 15 resolves the shadow-color path through ColorLong.
        // Build the color as a real sRGB ColorLong instead of passing a packed ARGB int.
        glowPaint.setShadowLayer(
            dp(90f),
            0f,
            0f,
            android.graphics.Color.pack(64f / 255f, 191f / 255f, 255f / 255f, 136f / 255f)
        )
